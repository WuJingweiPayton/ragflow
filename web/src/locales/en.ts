...
<ul>
  ...
  <li>The auto-keyword feature is dependent on the LLM and consumes a significant number of tokens.</li>
    ...
    flow: {
      ...
      dataProductDescription: `A component that retrieves information from specified data products. Ensure that the data products you select use the same embedding model.`,
      dataResourceDescription: `A component that retrieves information from specified data resources. Ensure that the data resources you select use the same embedding model.`,
      computingNodeDescription: `A component that retrieves information from specified computing nodes. Ensure that the computing nodes you select use the same embedding model.`,
