...
<ul>
  ...
  <li>The auto-keyword feature is dependent on the LLM and consumes a significant number of tokens.</li>
    ...
    flow: {
      ...
      customDescription: 'custom button Description',
      dataProductDescription: `This component is used to invoke data products from the trusted data space data product catalog service for use by downstream components`,
      dataResourceDescription: `This component is used to invoke data resources from the trusted data space data resource catalog service for use by downstream components`,
      computingNodeDescription: `This component is used to select computing services that meet computing power configuration and scheduling requirements from various nodes in the intelligent computing center for use by downstream components`,
  ...
  The above is the content you need to summarize.`,
      ...
      custom: 'Engr.Pips from Nigeria',
      dataProduct: 'Data Product',
      dataResource: 'Data Resource',
      computingNode: 'Computing Node',
      retrieval: 'Retrieval',
      generate: 'Generate',
      answer: 'Interact',
