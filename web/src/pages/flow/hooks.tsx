...
import {
  ...
  initialCodeValues,
  initialComputingNodeValues,
  initialConcentratorValues,
  initialDataProductValues,
  initialDataResourceValues,
  initialExeSqlValues,
...
export const useInitializeOperatorParams = () => {
  ...
  const initialFormValuesMap = useMemo(() => {
    return {
      ...
      [Operator.DataProduct]: initialDataProductValues,
      [Operator.DataResource]: initialDataResourceValues,
      [Operator.ComputingNode]: initialComputingNodeValues,
