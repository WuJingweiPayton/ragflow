...
import { ReactComponent as ComputingNodeIcon } from '@/assets/svg/computing-node.svg';
...
import { ReactComponent as DataResourceIcon } from '@/assets/svg/data-resource.svg';
...
export const operatorIconMap = {
  [Operator.DataProduct]: DataProductIcon,
  [Operator.DataResource]: DataResourceIcon,
  [Operator.ComputingNode]: ComputingNodeIcon,
...
> = {
  [Operator.DataProduct]: {
    backgroundColor: '#e8f4fd',
    color: '#1890ff',
  },
  [Operator.DataResource]: {
    backgroundColor: '#f6ffed',
    color: '#52c41a',
  },
  [Operator.ComputingNode]: {
...
export const componentMenuList = [
  {
    name: Operator.DataProduct,
  },
  {
    name: Operator.DataResource,
  },
  {
    name: Operator.ComputingNode,
  },
  {
...
export const initialDataProductValues = {
...
export const initialDataResourceValues = {
  similarity_threshold: 0.2,
  keywords_similarity_weight: 0.3,
  top_n: 8,
  use_kg: false,
...
export const initialComputingNodeValues = {
  similarity_threshold: 0.2,
  keywords_similarity_weight: 0.3,
  top_n: 8,
  use_kg: false,
...
export const RestrictedUpstreamMap = {
  ...
  [Operator.DataProduct]: [Operator.Begin, Operator.DataProduct],
  [Operator.DataResource]: [Operator.Begin, Operator.DataResource],
  [Operator.ComputingNode]: [Operator.Begin, Operator.ComputingNode],
...
export const NodeMap = {
  ...
  [Operator.DataProduct]: 'retrievalNode',
  [Operator.DataResource]: 'retrievalNode',
  [Operator.ComputingNode]: 'retrievalNode',
